   ...
   <Navbar.Collapse   className="flex-grow-0 " >
      ...
      <Link className="mx-2 text-black text-decoration-none text-white" to="/"><h6>Home</h6></Link>
       ...
       {user?.email ? <div className="d-flex">
        <Link className="mx-2 text-black text-decoration-none text-white" to="/dashboard"><h6>Dashboard</h6></Link>
        <h6><Link to='/' onClick={logOut} className=" text-white text-decoration-none"> Logout</Link></h6>
       </div>:
         <Link  className="mx-2 text-white text-decoration-none" to="/login"><h6>login</h6></Link>}
       </div>
