...
const Offers = () => {
  return (
    <div
      className="my-5 text-center m-0 p-0 overflow-hidden "
      style={{ fontFamily: "Poppins, sans-serif" }}
    >
      <h1 className="my-3 text-center">
        Flexibility, Agility &<br /> Freedom to go Anywhere, <br /> Anytime
      </h1>
      <h4>--------------------------</h4>
      <div className="container my-5">
        <div className="row  d-flex align-items-center">
          <div className="col-md-6 col-lg-6 ">
            <img
              style={{ width: "450px" }}
              src="https://i.ibb.co/bJkv1f1/renroll-1411816043.webp"
              alt=""
            />
          </div>
          <div className="col-md-6  text-start">
            ...
            <Button className="bg-info py-1 px-3 border-0 text-black">
              more...
            </Button>
          </div>
        </div>
