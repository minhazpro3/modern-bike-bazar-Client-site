...
const publishable_Key =
  "pk_test_51Jw7VaH3ev5JLZVRvA8lgx8YaHqTlusMziZgMjollIE1gPBWx3kP33OB2DK3Fnwpgr2YetIlBzzcMNbzw5Nxbm6T00ilgAiC9a";
const Pay = () => {
  ...
  return (
    <div>
      ...
      <h3 className="text-center my-5">
        Pay for: <span className="text-primary"> {product.title}</span>{" "}
      </h3>
