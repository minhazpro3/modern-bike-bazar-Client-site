...
const Footer = () => {
  return (
    <div
      className="bg-light my-5 py-5 text-center"
      ...
      <div className="container">
        <div>
          <div className="d-md-flex gap-3">
            <input
              className="w-75 search-input bg-primary border-0 border-white text-white px-3 rounded-3"
              type="text"
              placeholder="Search"
            />
            <h2>Search Dream</h2>
        ...
        <div className="row align-items-center">
          <div className="col-md-3 pe-5 text-start">
            ...
            />
            <div
              style={{ fontFamily: "'Poppins', sans-serif", paddingTop: "2px" }}
            >
              ...
              >
                {" "}
                Read more <i className="fas fa-arrow-right px-2 "></i>{" "}
              </button>
            </div>
          ...
          <div className="col-md-3 ">
            ...
            <div className="d-flex align-items-center gap-3">
              <h4>
                <i className="far fa-envelope pt-3 text-primary"></i>
              </h4>
          ...
          <div className="col-md-3">
            <img
              ...
              src="https://www.pngitem.com/pimgs/m/47-479479_payment-methods-in-bangladesh-hd-png-download.png"
              alt=""
            />
          </div>
        </div>
